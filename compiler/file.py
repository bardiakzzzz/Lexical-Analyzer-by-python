...
tk_Integer, tk_String, tk_BigString, tk_donoqte = range(33)
...
def string_lit(start, err_line, err_col):
    ...
    if (next_ch() == start):
        ...
        next_ch()
        next_ch()
        return tk_BigString, err_line, err_col, '""' + text + '""'
    next_ch()
...
while True:
    ...
    if tok == tk_Integer:
        ...
        print("  %s" % (t[3]))
    elif tok == tk_String or tok == tk_BigString:
        print('  "%s"' % (t[3]))
    else:
        print("")
